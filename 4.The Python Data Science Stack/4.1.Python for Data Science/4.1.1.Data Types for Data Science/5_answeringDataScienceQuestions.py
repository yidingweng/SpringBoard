'''
1. Reading your data with CSV Reader and Establishing your Data Containers
'''
...
'''
### crucial step, pop() applies to row(element), pop() can also take numbers
'''
crime_data.pop(0)
...
for data in crime_data:
    ...
    '''
    ### [date.month] was hard to figure out
    '''
...
for row in crime_data:
    ...
    if date.year == 2016:
        ...
        '''
        ###by not doing following is very important
...
'''
### one of the crucial mistakes, should be DictReader,not just reader
for row in csv.reader(csvfile):
'''
...
'''
### .items(), is essential for unpacking
'''
...
'''
### having set() was crucial for unique data
'''
