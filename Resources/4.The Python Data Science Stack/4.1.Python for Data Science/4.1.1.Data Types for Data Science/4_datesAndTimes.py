...
'''
### Got everything but not this part
'''
...
for orig_dt, ridership in daily_summaries:
    ...
    ### does not work, ValueError: astimezone() cannot be applied to a naive datetime
    '''
...
'''
6.
### last couple line cannot get it.
'''
...
import pendulum
'''
### the following line was a bit struggling
'''
