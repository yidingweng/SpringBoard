...
'''### Downsample df_clean by day and aggregate by mean: daily_mean_2011,  resample('...') not resample['...']'''
...
attempt: daily_temp_climate = daily_climate['Temperature'].reset_index()'''
...
attempt: sunny = df_clean.loc['CLR', 'sky_condition']'''
sunny = df_clean.loc[df_clean['sky_condition']=='CLR']

'''### Select days that are overcast: overcast
overcast = df_clean.loc['OVC', 'sky_condition']'''
...
###creat Boolean before pass into the filter
'''
